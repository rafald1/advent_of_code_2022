...
size_t findShortestPath(const std::vector<std::string>& grid) {
...
int main() {
    try {
        ...
        // std::vector<std::string> processedGrid = processData("../test_input/24.txt");  // 18
        
        size_t result = findShortestPath(processedGrid);
